...
const token = '7950825715:AAEAjW2G95EyGZv0QpeMv6wUWWp85T2fVww';
...
bot.onText(/^\/AttackL7(?: (.+) (.+))?$/, (msg, match) => {
  ...
  if (!isAdmin) {
    bot.sendMessage(chatId, 'Masa premium anda telah habis jika anda ingin memperpanjang masa premium silahkan hubungi owner @XywrVm');
    return;
  }
